...
function populateContentAttributesSelect(selectElement) {
  const ariaAttributes = [
    ...
    "aria-atomic   --UPDATED TO ENUMERATED--",
    "aria-autocomplete   --UPDATED TO ENUMERATED--",
    "aria-braillelabel",
    "aria-brailleroledescription",
    "aria-busy   --UPDATED TO ENUMERATED--",
    "aria-checked   --UPDATED TO ENUMERATED--",
    "aria-colcount",
    "aria-colindex",
    "aria-colindextext",
    "aria-colspan",
    "aria-controls",
    "aria-current   --UPDATED TO ENUMERATED--",
    "aria-describedby",
    "aria-description",
    "aria-details",
    "aria-disabled   --UPDATED TO ENUMERATED--",
    "aria-errormessage",
    "aria-expanded   --UPDATED TO ENUMERATED--",
    "aria-flowto",
    "aria-haspopup   --UPDATED TO ENUMERATED--",
    "aria-hidden   --UPDATED TO ENUMERATED--",
    "aria-invalid   --UPDATED TO ENUMERATED--",
    "aria-keyshortcuts",
    "aria-label",
    "aria-labelledby",
    "aria-level",
    "aria-live   --UPDATED TO ENUMERATED--",
    "aria-modal   --UPDATED TO ENUMERATED--",
    "aria-multiline   --UPDATED TO ENUMERATED--",
    "aria-multiselectable   --UPDATED TO ENUMERATED--",
    "aria-orientation   --UPDATED TO ENUMERATED--",
    "aria-owns",
    "aria-placeholder",
    "aria-posinset",
    "aria-pressed   --UPDATED TO ENUMERATED--",
    "aria-readonly   --UPDATED TO ENUMERATED--",
    "aria-relevant",
    "aria-required   --UPDATED TO ENUMERATED--",
    "aria-roledescription",
    "aria-rowcount",
    "aria-rowindex",
    "aria-rowindextext",
    "aria-rowspan",
    "aria-selected   --UPDATED TO ENUMERATED--",
    "aria-setsize",
    "aria-sort   --UPDATED TO ENUMERATED--",
    "aria-valuemax",
    "aria-valuemin",
    "aria-valuenow",
    "aria-valuetext"
